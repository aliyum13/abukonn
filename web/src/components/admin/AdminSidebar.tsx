...
// Which roles may see each nav item. 'admin' implicitly sees everything (handled
// in the filter below). class_coordinator and editor get scoped access.
const NAV = [
  {
    href: '/admin',
    label: 'Dashboard',
    icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',
    roles: ['admin', 'class_coordinator', 'editor'],
  },
  {
    href: '/admin/users',
    label: 'Users',
  ...
  },
  {
    ...
    roles: ['admin', 'class_coordinator'],
  },
  {
    href: '/admin/academic-calendar',
    label: 'Academic Calendar',
    icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 9v7.5m-9-6h.008v.008H12v-.008z',
    roles: ['admin', 'class_coordinator'],
  },
  {
  ...
  return (
    <aside className="flex h-full w-64 shrink-0 flex-col bg-brand-950">
      ...
      <div className="border-t border-brand-800 px-3 py-3">
        <Link
          href="/feed"
          className="flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium text-brand-300 transition hover:bg-brand-800 hover:text-white"
        >
        ...
        <button
          ...
          className="mt-1 flex w-full items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium text-brand-300 transition hover:bg-red-900/40 hover:text-red-300"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
