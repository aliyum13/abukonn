  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      <div className="mb-5 grid gap-3 sm:grid-cols-3">
        ...
        {/* Mock Exams — placeholder, not yet built. Non-clickable, badged
            "Coming soon" so it sets expectations / gauges interest without
            promising a live feature. Will fold into the Pro tier when built. */}
        <Card className="h-full opacity-75 dark:border-[#222]">
          <CardContent className="flex items-center gap-4 p-4">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-surface-muted text-ink-muted">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25z" />
              </svg>
            </div>
            <div className="min-w-0 flex-1">
              <p className="font-semibold text-ink">Mock Exams</p>
              <p className="text-caption text-ink-muted">Practice past questions &amp; test yourself</p>
            </div>
            <span className="shrink-0 rounded-full bg-brand-50 px-2.5 py-1 text-[11px] font-semibold text-brand-600 dark:bg-brand-950 dark:text-brand-400">
              Coming soon
            </span>
          </CardContent>
        </Card>
